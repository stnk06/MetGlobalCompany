...
public partial class SalesInvoiceDetailFormViewModel : BaseViewModel
{
    ...
    public SalesInvoiceDetail Model { get; private set; } = new();

    public SalesInvoiceDetailFormViewModel(IPriceService priceService, IDialogService dialogService, IServiceProvider serviceProvider)
    {
    ...
    public void Initialize(SalesInvoiceDetail detail, int? contractId, DateTime documentDate)
    {
        Title = detail.Id == 0 ? "Добавление товара (УПД)" : "Редактирование товара (УПД)";
